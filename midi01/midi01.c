...
// 38400  38426 .06 1093
    ...
    //42000000/(38400*16) = 68.359..
    //..359.. * 16 = 5.75
    //5/16 = .3125 6/16 = .375
    //42000000/(16*68.3125) = 38426  26
    //42000000/(16*68.375) = 38391  9
    // divisor 68 fractional divisor 6
    PUT32(USART3_BRR,(68<<4)|(6<<0));
...
{
    while (( GET32(USART3_SR) & (1<<7)) == 0) continue;
    PUT32(USART3_DR,x);
}
//-------------------------------------------------------------------
